...
#include "../../treeRobot3/serialport.h"
...
QT_MOC_LITERAL(13, 138, 13)
    },
    "serialPort\0eulerDataUpdated\0\0s\0"
    "openSerialPort\0name\0closeSerialPort\0"
...
void serialPort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->eulerDataUpdated((*reinterpret_cast< const QStringList(*)>(_a[1]))); break;
        ...
        {
            typedef void (serialPort::*_t)(const QStringList & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&serialPort::eulerDataUpdated)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void serialPort::eulerDataUpdated(const QStringList & _t1)
{
